...
if(isset($_POST['btn']))
{
    ...
    $sql = "SELECT * FROM `students` WHERE  (`username` = '$username' OR   `uid` = '$username')  AND `pass` = '$password' ";
    ...
    <body>
        <div class="wrap">
            ...
            <div class="page-body animated slideInDown">
                ...
                <!--LOGO-->
                <div class="logo">
                    <h3 class="text-center m-0 p-0">Log In - Student</h3>
                            ...
                            <form method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
                                <div class="form-group mt-md">
                                    <span class="input-with-icon">
                                        <input type="text" class="form-control"  placeholder="Username or ID " name="username" value="<?= isset($username) ? $username : '' ?>">
...
-->
                                ...
                                <div class="form-group text-center">
                                    ...
                                    <a href="register.php" class="btn btn-block mt-sm">Registration</a>
