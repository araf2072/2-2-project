...
<html lang="en" class="fixed accounts sign-in">
    ...
    if(isset($input_errors['batch'])){ ?>
                                ...
                                <div class="form-group mt-md">
                                <input type="text" class="form-control" placeholder="Department/Institute" name="department_institute" value="<?= isset($department_institute) ?  $department_institute : '' ?>">
                                    <?php 
    if(isset($input_errors['department_institute'])){ ?>
                                    <span class = "error-text"><?= $input_errors['department_institute'] ?></span>
                                    <?php }?>
                                </div>
                                <div class="form-group mt-md">
    ...
    if(isset($input_errors['uvid'])){ ?>
                                ...
                                <div class="form-group mt-md">
                                    <input type="text" class="form-control" placeholder="Hall" name="hall" value="<?= isset($hall) ?  $hall : '' ?>">
                                    <?php 
    if(isset($input_errors['hall'])){ ?>
                                    <span class = "error-text"><?= $input_errors['hall'] ?></span>
                                    <?php }?>
                                </div>
                                <div class="form-group mt-md">
    ...
    if(isset($input_errors['phone'])){ ?>
                                ...
                                <div class="form-group mt-md">
                                    <input type="text" class="form-control" placeholder="Blood Group" name="blood_grp" value="<?= isset($blood_grp) ?  $blood_grp : '' ?>">
                                    <?php 
    if(isset($input_errors['blood_grp'])){ ?>
                                    <span class = "error-text"><?= $input_errors['phone'] ?></span>
                                    <?php }?>
                                </div>
                                <div class="form-group mt-md">
...
-->
                                <div class="form-group text-center">
                                    ...
                                    <a href="../log.php" class="btn btn-block mt-sm">Back login panel</a>
