...
if(isset($_POST["submit"])){
    ...
    if($pass === $cpassword){
        ...
        if($image_size > 524880){
            ...
            $sql = "UPDATE students  SET name='$name' , pass='$pass', image= '$image_new_name' WHERE id=  id = '{$data["id"]}'";
            $result = mysqli_query($con,$sql);
            if($result){
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            ?>
                    ...
                    <div class="inputBox">
                        ...
                        <input type="password" id="pass" name="pass" placeholder="Enter password" value="<?php echo $row['pass'];?>" required>
                    </div>
                    <div class="inputBox">
                    ...
                    <img src="..images/student/<?php echo $data['image']?>" width="150px" height="auto" alt="">
            <?php
